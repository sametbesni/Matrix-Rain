...
chars = ['ｦ', 'ｱ', 'ｳ', 'ｴ', 'ｵ', 'ｶ', 'ｷ', 'ｹ', 'ｺ', 'ｻ', 'ｼ', 'ｽ', 'ｾ', 'ｿ', 'ﾀ', 'ﾂ', 'ﾃ', 'ﾅ', 'ﾆ', 'ﾇ', 'ﾈ',
         'ﾊ', 'ﾋ', 'ﾎ', 'ﾏ', 'ﾐ', 'ﾑ', 'ﾒ', 'ﾓ', 'ﾔ', 'ﾕ', 'ﾗ', 'ﾘ', 'ﾜ', '9', '4', '8', '3', '7', '0', '5', '2',
         '6', '1', ':', '.', '"', '=', '*', '+', '-', '¦', '|', '_', '╌', '日', 'a', 'g', 'y', 'r', 'n', 'z',
         'e', 's', 'u', 'o', 'p', 'q', 'v', 'm', 'k', 'l', 'b', 'c', 'x', 'u', 't', 'i', 'w', 'd', 'j', 'ç', 'h',
         '#', '&', '/', '-']

font = pygame.font.Font('font_matrix\MS Mincho.ttf', FONT_SIZE)
font_2 = pygame.font.Font('font_matrix\MS Mincho.ttf', FONT_SIZE - FONT_SIZE // 6)
font_3 = pygame.font.Font('font_matrix\MS Mincho.ttf', FONT_SIZE - FONT_SIZE // 3)
